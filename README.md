...
```bash
$ whoami
> Harshit Gupta — B.Tech Computer Engineering @ KJ Somaiya College of Engineering ('23–'27)
...
- **AI Security Engineering Intern** — *IIT Bombay Trust Lab, Summer of Code* `May 2026 – Jul 2026`
  Built a native Kibana plugin turning natural-language security investigations into executable **ES|QL** queries, backed by a provider-agnostic LLM layer (cloud + local models, fallback handling, cost analysis).
- **Full Stack Developer Intern** — *Riidl (Somaiya Vidyavihar's innovation lab)* `Mar 2026 – May 2026`
  Shipped full-stack features with React, Node, Express & REST APIs — reusable components, role-based workflows, and performance tuning across internal innovation platforms.
...
<sub>Everything below appears in real projects on this profile.</sub>
